 ...
 * @param comm              MPI communicator object
 */
void parallel_prefix(const int n, const double* values,
  double* prefix_results, const int OP, const MPI_Comm comm);
 ...
 * @return                  Result of evaluating the polynomial function
 */
double mpi_poly_evaluator1(const double x, const int n, const double* constants, const MPI_Comm comm);
